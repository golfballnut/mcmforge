 ...
 */
export function transformCompanyId(id) {
 ...
 */
export function transformAdapterType(adapterType) {
 ...
 */
export function shouldDropTable(tableName) {
    if (tableName.startsWith('plugin_'))
        return true;
    return DROP_TABLES.includes(tableName);
}
// ── Builder functions ─────────────────────────────────────────────────────
/**
 ...
 */
export function buildAgentRow(src) {
    return {
 ...
 */
export function buildProjectRow(src) {
    return {
        company_id: transformCompanyId(src.company_id),
        name: src.name,
 ...
 */
export function buildGoalRow(src, agentIdMap, goalIdMap) {
 ...
 */
export function buildIssueRow(src, forgeCompanyId, agentIdMap, projectIdMap, goalIdMap) {
 ...
 */
export function buildCommentRow(src, forgeCompanyId, issueIdMap, agentIdMap) {
 ...
 */
export function buildApprovalRow(src, forgeCompanyId, agentIdMap, issueIdMap) {
...
//# sourceMappingURL=etl-transforms.js.map