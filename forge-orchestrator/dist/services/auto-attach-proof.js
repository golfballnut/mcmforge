 ...
 */
export function parseIdentifierFromPath(dirName) {
 ...
 */
export async function runAutoAttachScan(supabase, researchDir) {
    ...
    for (const entry of entries) {
        ...
        for (const filename of files) {
            ...
            if (uploadErr) {
                ...
                const alreadyExists = typeof uploadErr.message === 'string' &&
            ...
            logger.info({ issueId, identifier, filename, storagePath }, 'Auto-attach: uploaded proof artifact');
            result.uploaded++;
        }
    }
...
//# sourceMappingURL=auto-attach-proof.js.map