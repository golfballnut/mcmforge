...
import {
  ...
  FORGE_COMPANY_ID,
  DROP_TABLES,
} from '../migration/etl-transforms.js';
...
const ISSUE_ID_MAP = new Map<string, string>([
...
const PROJECT_ID_MAP = new Map<string, string>([
  [PAPERCLIP_PROJECT.id, 'forge-project-id-01'],
]);

const GOAL_ID_MAP = new Map<string, string>([
